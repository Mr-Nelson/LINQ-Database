...
namespace DatabaseFirstLINQ
{
    ...
    private void ProblemThirteen()
        ...
        private void ProblemFourteen()
        {
            ...
            var userCart = _context.Users.Where(uc => uc.Email == "david@gmail.com").Select(uc =>uc.Id).FirstOrDefault();
            var newProduct = _context.Products.Where(np => np.Name == "Microsoft Holo Lens 2").Select(np => np.Id).FirstOrDefault();
        ...
        private void ProblemSixteen()
        {
            ...
            var Product = _context.Products.Where(pu => pu.Price == 3500).FirstOrDefault();
            Product.Price = 5199;
        ...
        private void ProblemEighteen()
        {
            ...
            var roleRelation = _context.UserRoles.Where(ur => ur.User.Email == "oda@gmail.com").FirstOrDefault();
        ...
        private void BonusOne()
        {
            ...
            var emailCheck = Console.ReadLine().ToString();
            Console.WriteLine("Enter your password: ");
            Console.CursorVisible = false;
            var passwordCheck = Console.ReadLine().ToString();


            var theUser = _context.Users.Where(pt => pt.Password == passwordCheck && pt.Email == emailCheck).FirstOrDefault();


            if (theUser != null)

            {
                Console.WriteLine("boom, we found you");
